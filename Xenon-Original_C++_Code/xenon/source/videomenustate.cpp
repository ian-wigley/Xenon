...
CVideoMenuState *CVideoMenuState::m_instance = 0;

//-------------------------------------------------------------

CVideoMenuState::CVideoMenuState()
{
}
...
CGameState *CVideoMenuState::instance()
{
	if (!m_instance)
		m_instance = new CVideoMenuState;
...
void CVideoMenuState::copyOptionsToMenu()
{
...
void CVideoMenuState::copyMenuToOptions()
{
