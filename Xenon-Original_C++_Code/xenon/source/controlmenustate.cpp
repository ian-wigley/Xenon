...
CControlMenuState *CControlMenuState::m_instance = 0;
...
CGameState *CControlMenuState::instance()
{
	if (!m_instance)
		m_instance = new CControlMenuState;
