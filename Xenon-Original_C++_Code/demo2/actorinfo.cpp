...
ActorInfo CActorInfoList::m_info_list[INFO_TOTAL] = {
	...
	{	"SmallStandardAsteroid",	ACTOR_TYPE_ALIEN,	0,		32,	32,	16,	16,	16.f,1,	10	},
	{	"MediumStandardAsteroid",	ACTOR_TYPE_ALIEN,	0,		64,	64,	32,	32,	12.f,2,	20	},
	{	"BigStandardAsteroid",		ACTOR_TYPE_ALIEN,	0,		96,	96,	48,	48,	8.f, 3, 40	},
	{	"SmallHighDensityAsteroid",	ACTOR_TYPE_ALIEN,	0,		32,	32,	16,	16, 16.f, 2, 20	},
	{	"MediumHighDensityAsteroid",ACTOR_TYPE_ALIEN,	0,		64,	64,	32,	32,	12.f, 4, 40	},
	{	"BigHighDensityAsteroid",	ACTOR_TYPE_ALIEN,	0,		96,	96,	48,	48,  8.f, 4, 80	},
	{	"SmallIndestuctibleAsteroid",ACTOR_TYPE_ALIEN,	0,		32,	32,	16,	16,	16.f, INFINITE_SHIELD, 0	},
	{	"MediumIndestuctibleAsteroid",ACTOR_TYPE_ALIEN,	0,		64,	64,	32,	32,	12.f, INFINITE_SHIELD, 0	},
	{	"BigIndestuctibleAsteroid",ACTOR_TYPE_ALIEN,	0,		96,	96,	48,	48,	8.f, INFINITE_SHIELD, 0		},
	...
	{	"SmallExplosion",			ACTOR_TYPE_ALIEN,	0,		16,16,8,8,40.f,INFINITE_SHIELD,0	},
	{	"MediumExplosion",			ACTOR_TYPE_ALIEN,	0,		32,32,16,16,40.f,INFINITE_SHIELD,0	},
	{	"BigExplosion",				ACTOR_TYPE_ALIEN,	0,		64,64,32,32,40.f,INFINITE_SHIELD,0	},
	{	"StandardDustEffect",		ACTOR_TYPE_EFFECT,	0,		4,4,2,2,16.f,INFINITE_SHIELD,0	},
	{	"HighDensityDustEffect",	ACTOR_TYPE_EFFECT,	0,		4,4,2,2,16.f,INFINITE_SHIELD,0	},
